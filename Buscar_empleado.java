...
public class Buscar_empleado extends javax.swing.JFrame {
    ...
    public void cargarBuscarEmpleados(Connection conn,String empleado){
        DefaultTableModel modelo = (DefaultTableModel) jTable1.getModel();
        modelo.setRowCount(0);
        try {
            PreparedStatement statement = conn.prepareStatement("SELECT * from empleados WHERE Nombre_empleado = ?");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new DefaultTableModel(
            ...
            new String [] {
                "EmpleadoID", "Nombre_empleado", "Area_de_trabajo", "Salario", "Estatus"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) throws Exception {                                         
        ...
        cargarBuscarEmpleados(conn,empleado);
    }                                        
